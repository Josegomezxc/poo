...
class CrudClients(ICrud):
    ...
    def consult(self):
        ...
        tipo_cliente = validar.solo_numeros("Error: Ingrese 1, 2, 3 o 4", 19, 9)
        json_file = JsonFile(path+'/archivos/clients.json')
        clients = []
...
def ConsultasGenerales():
    ...
    # se identifica el json productos
    json_file = JsonFile(path+'/archivos/products.json') 
    ...
    print("\033[1;32;40mPRODUCTO CON MAYOR STOCK\033[0m")
    print(f"{products_major_stock}\n")
    ...
    print("\033[1;31;40mPRODUCTO CON MENOR STOCK\033[0m")
    print(f"{products_menor_stock}\n")
    ...
    print("\033[1;34;40mCLIENTES CON MÁS FACTURAS\033[0m")
